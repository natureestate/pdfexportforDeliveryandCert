            ...
            >
                ...
                >
                    ...
                    <div className="sticky top-0 bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-600 px-6 py-4 flex items-center justify-between z-10">
                        <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100">ข้อมูลบริษัท</h2>
                        <button
                            onClick={onClose}
                    ...
                    <div className="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 disabled:bg-gray-100 dark:disabled:bg-slate-700 disabled:cursor-not-allowed bg-white dark:bg-slate-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 disabled:bg-gray-100 dark:disabled:bg-slate-700 disabled:cursor-not-allowed resize-none bg-white dark:bg-slate-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500"
                            />
                        </div>
                        ...
                        <div>
                            <label htmlFor="company-taxId" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                เลขประจำตัวผู้เสียภาษี
                            </label>
                            <input
                                type="text"
                        ...
                        <div className="border-t border-gray-200 dark:border-slate-600 pt-4 mt-4">
                            <div className="flex flex-wrap items-center gap-2 mb-4">
                                ...
                                <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">ข้อมูลสาขา</h3>
                                <span className="text-xs text-gray-500 dark:text-gray-400">(ตามประกาศอธิบดีกรมสรรพากร ฉบับที่ 200)</span>
                            </div>

                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {/* รหัสสาขา */}
                                <div>
                                    <label htmlFor="company-branchCode" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        รหัสสาขา (5 หลัก)
                                    </label>
                                    <input
                                        type="text"
                                        ...
                                        placeholder="00000"
                                        maxLength={5}
                                        className="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 disabled:bg-gray-100 dark:disabled:bg-slate-700 disabled:cursor-not-allowed font-mono text-center bg-white dark:bg-slate-700 text-gray-900 dark:text-gray-100"
                                    />
                                ...
                                {/* ชื่อสาขา */}
                                <div>
                                    <label htmlFor="company-branchName" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        ชื่อสาขา
                                    </label>
                                    <input
                                        type="text"
                            ...
                            <div className="mt-3 p-3 bg-gray-50 dark:bg-slate-700/50 rounded-lg border border-gray-200 dark:border-slate-600">
                                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">ตัวอย่างที่จะแสดงในเอกสาร:</p>
                    ...
                    {/* Modal Footer */}
                    <div className="sticky bottom-0 bg-gray-50 dark:bg-slate-700/50 border-t border-gray-200 dark:border-slate-600 px-6 py-4 flex justify-end gap-3">
                        <button
                            onClick={onClose}
                            disabled={isSaving}
                            className="px-6 py-2 bg-gray-200 dark:bg-slate-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-slate-500 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            ยกเลิก
                        </button>
                        <button
