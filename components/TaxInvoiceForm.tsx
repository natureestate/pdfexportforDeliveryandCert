...
import { TaxInvoiceData, TaxInvoiceItem, LogoType } from '../types';
        ...
        <div className="space-y-8 pt-4">
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                    <div>
                        <label htmlFor="taxInvoiceDate" className="block text-xs sm:text-sm font-medium text-slate-700">วันที่ออกใบกำกับภาษี</label>
