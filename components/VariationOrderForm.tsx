        ...
        <div className="space-y-8 pt-4">
            ...
            <div className="space-y-6">
                ...
                <div className="overflow-x-auto -mx-3 sm:mx-0">
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-xs sm:text-sm" style={{ tableLayout: 'fixed' }}>
                        <thead className="bg-gray-50 dark:bg-slate-700">
                            <tr>
                                <th scope="col" className="px-2 sm:px-3 py-1.5 sm:py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider" style={{ width: '8%' }}>ประเภท</th>
                                <th scope="col" className="px-2 sm:px-3 py-1.5 sm:py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider" style={{ width: '26%' }}>รายละเอียด</th>
                                ...
                                <th scope="col" className="px-2 sm:px-3 py-1.5 sm:py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider" style={{ width: '16%' }}>ราคาต่อหน่วย</th>
                                <th scope="col" className="px-2 sm:px-3 py-1.5 sm:py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider" style={{ width: '16%' }}>จำนวนเงิน</th>
                        ...
                        <tbody className="bg-white dark:bg-slate-800 divide-y divide-gray-200 dark:divide-gray-700">
                            {data.items.map((item, index) => (
                                <tr key={index} className={item.itemType === 'new' ? 'bg-green-50 dark:bg-green-900/20' : 'bg-red-50 dark:bg-red-900/20'}>
                                    ...
                                    <td className="px-1 sm:px-2 py-1">
                                        <input type="number" step="0.01" value={item.amount} readOnly className={`w-full rounded-md border-gray-300 dark:border-slate-600 shadow-sm text-xs sm:text-sm font-medium px-1.5 sm:px-2 ${item.itemType === 'new' ? 'bg-green-100 dark:bg-green-900/40 text-green-900 dark:text-green-200' : 'bg-red-100 dark:bg-red-900/40 text-red-900 dark:text-red-200'}`} />
                                    </td>
