...
const PolicyModal: React.FC<PolicyModalProps> = ({ isOpen, onClose, type }) => {
    ...
    return (
        <>
            {/* Overlay */}
            <div 
                className="fixed inset-0 bg-black bg-opacity-50 dark:bg-opacity-70 z-[9999] flex items-center justify-center p-4"
                onClick={onClose}
            >
                {/* Modal Content */}
                <div 
                    className="bg-white dark:bg-slate-800 rounded-lg shadow-2xl dark:shadow-slate-900/50 max-w-3xl w-full max-h-[90vh] overflow-y-auto animate-fade-in"
                ...
                >
                    ...
                    {/* Body */}
                    <div className="p-6 space-y-4 text-gray-700 dark:text-slate-300">
                        {isTerms ? (
                            <>
                                <div className="prose max-w-none dark:prose-invert">
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-3">1. การยอมรับเงื่อนไข</h3>
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-3">2. คำจำกัดความ</h3>
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-3">3. สิทธิ์ในการใช้งาน</h3>
                                    <p className="text-sm leading-relaxed mb-4">
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-3">4. การรับผิดชอบ</h3>
                                    <p className="text-sm leading-relaxed mb-4">
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-3">5. การยกเลิกบริการ</h3>
                                    <p className="text-sm leading-relaxed mb-4">
                        ...
                        หรือใช้บริการในทางที่ผิดกฎหมาย โดยไม่ต้องแจ้งให้ทราบล่วงหน้า
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-3">6. การเปลี่ยนแปลงเงื่อนไข</h3>
                                    <p className="text-sm leading-relaxed mb-4">
                            ...
                            <>
                                <div className="prose max-w-none dark:prose-invert">
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-3">1. ข้อมูลที่เรารวบรวม</h3>
                                    <p className="text-sm leading-relaxed mb-4">
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-3">2. วัตถุประสงค์ในการใช้ข้อมูล</h3>
                                    <p className="text-sm leading-relaxed mb-4">
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-3">3. การเก็บรักษาข้อมูล</h3>
                                    <p className="text-sm leading-relaxed mb-4">
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-3">4. การเปิดเผยข้อมูล</h3>
                                    <p className="text-sm leading-relaxed mb-4">
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-3">5. สิทธิ์ของคุณ</h3>
                                    <p className="text-sm leading-relaxed mb-4">
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-3">6. ความปลอดภัยของข้อมูล</h3>
                                    <p className="text-sm leading-relaxed mb-4">
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-3">7. การเปลี่ยนแปลงนโยบาย</h3>
                                    <p className="text-sm leading-relaxed mb-4">
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-3">8. ติดต่อเรา</h3>
                                    <p className="text-sm leading-relaxed mb-4">
                    ...
                    {/* Footer */}
                    <div className="sticky bottom-0 bg-gray-50 dark:bg-slate-700 border-t border-gray-200 dark:border-slate-600 px-6 py-4 rounded-b-lg">
                        <button
                            onClick={onClose}
