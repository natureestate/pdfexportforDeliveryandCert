        ...
        <div className="space-y-8 pt-4">
            ...
            <div className="space-y-6">
                ...
                <div className="text-sm text-gray-600">
                    ...
                    <span className="text-xs text-gray-500 ml-2">(รูปแบบ: RC-YYMMDDXX)</span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="receiptDate" className="block text-sm font-medium text-slate-700">วันที่ออกใบเสร็จ</label>
                        <input type="date" id="receiptDate" value={formatDateForInput(data.receiptDate)} onChange={(e) => handleDataChange('receiptDate', e.target.value ? new Date(e.target.value) : null)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-gray-50" />
                    </div>
                    <div>
                        <label htmlFor="referenceNumber" className="block text-sm font-medium text-slate-700">เลขที่อ้างอิง</label>
                        <input type="text" id="referenceNumber" value={data.referenceNumber || ''} onChange={(e) => handleDataChange('referenceNumber', e.target.value)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-gray-50" placeholder="เช่น เลขที่ใบแจ้งหนี้" />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="paymentMethod" className="block text-sm font-medium text-slate-700">วิธีการชำระเงิน</label>
                        <select id="paymentMethod" value={data.paymentMethod || ''} onChange={(e) => handleDataChange('paymentMethod', e.target.value)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-gray-50">
                    ...
                    <div>
                        <label htmlFor="paidAmount" className="block text-sm font-medium text-slate-700">จำนวนเงินที่รับ (บาท)</label>
                        <input type="number" id="paidAmount" value={data.paidAmount} onChange={(e) => handleDataChange('paidAmount', parseFloat(e.target.value) || 0)} step="0.01" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-gray-50" />
                    </div>
                    {data.changeAmount > 0 && (
