        ...
        <div className="space-y-8 pt-4">
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                        <div>
                            <label htmlFor="fromName" className="block text-xs sm:text-sm font-medium text-slate-700">จาก (ชื่อ) *</label>
                            <input 
                                type="text" 
                                id="fromName" 
                                value={data.fromName} 
                        ...
                        <div>
                            <label htmlFor="fromPosition" className="block text-xs sm:text-sm font-medium text-slate-700">ตำแหน่ง/ฝ่าย</label>
                            <input 
                                type="text" 
                                id="fromPosition" 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                        <div>
                            <label htmlFor="toName" className="block text-xs sm:text-sm font-medium text-slate-700">ถึง (ชื่อผู้รับ) *</label>
                            <input 
                                type="text" 
                                id="toName" 
                                value={data.toName} 
                        ...
                        <div>
                            <label htmlFor="toPosition" className="block text-xs sm:text-sm font-medium text-slate-700">ตำแหน่งผู้รับ</label>
                            <input 
                                type="text" 
                                id="toPosition" 
                    ...
                    <div>
                        <label htmlFor="cc" className="block text-xs sm:text-sm font-medium text-slate-700">สำเนาถึง (คั่นด้วย comma)</label>
                        <input 
                            type="text" 
                            id="cc" 
                            value={data.cc || ''} 
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                        <div>
                            <label htmlFor="projectName" className="block text-xs sm:text-sm font-medium text-slate-700">ชื่อโครงการ / ลูกค้า</label>
                            <input 
                                type="text" 
                                id="projectName" 
                        ...
                        <div>
                            <label htmlFor="projectId" className="block text-xs sm:text-sm font-medium text-slate-700">รหัสโครงการ</label>
                            <input 
                                type="text" 
                                id="projectId" 
                    ...
                    <div>
                        <label htmlFor="referenceDocument" className="block text-xs sm:text-sm font-medium text-slate-700">อ้างอิงถึงเอกสารเดิม</label>
                        <input 
                            type="text" 
                ...
                <div className="space-y-4">
                    <div>
                        <label htmlFor="purpose" className="block text-xs sm:text-sm font-medium text-slate-700">วัตถุประสงค์ *</label>
                        <select
                            id="purpose"
                            value={data.purpose}
                    ...
                    <div>
                        <label htmlFor="details" className="block text-xs sm:text-sm font-medium text-slate-700">รายละเอียด *</label>
                        <textarea 
                            id="details" 
                            value={data.details} 
                    ...
                    <div>
                        <label htmlFor="reason" className="block text-xs sm:text-sm font-medium text-slate-700">เหตุผล</label>
                        <textarea 
                            id="reason" 
                            value={data.reason || ''} 
                ...
                <div className="space-y-4">
                    <div>
                        <label htmlFor="actionRequired" className="block text-xs sm:text-sm font-medium text-slate-700">สิ่งที่ต้องดำเนินการ *</label>
                        <textarea 
                            id="actionRequired" 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                        <div>
                            <label htmlFor="deadline" className="block text-xs sm:text-sm font-medium text-slate-700">กำหนดเสร็จ</label>
                            <input 
                                type="date" 
                                id="deadline" 
                        ...
                        <div>
                            <label htmlFor="contactPerson" className="block text-xs sm:text-sm font-medium text-slate-700">ผู้ประสานงาน (ชื่อ)</label>
                            <input 
                                type="text" 
                                id="contactPerson" 
                    ...
                    <div>
                        <label htmlFor="contactPhone" className="block text-xs sm:text-sm font-medium text-slate-700">เบอร์โทรผู้ประสานงาน</label>
                        <input 
                            type="text" 
                            id="contactPhone" 
                ...
                <div className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                        <div>
                            <label htmlFor="issuedByName" className="block text-xs sm:text-sm font-medium text-slate-700">ชื่อ-นามสกุลผู้ออก Memo *</label>
                            <input 
                                type="text" 
                                id="issuedByName" 
                        ...
                        <div>
                            <label htmlFor="issuedByPosition" className="block text-xs sm:text-sm font-medium text-slate-700">ตำแหน่งผู้ออก Memo *</label>
                            <input 
                                type="text" 
                                id="issuedByPosition" 
                    ...
                    <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="requireResponse" className="ml-2 block text-xs sm:text-sm text-gray-700">
