            ...
            <header className="flex justify-between items-start pb-4 border-b-2 border-gray-800">
                ...
                <div className="w-3/5 text-right">
                    ...
                    <div className="mt-4 text-xs space-y-1">
                        <p><span className="font-semibold text-gray-600">เลขที่:</span> {data.taxInvoiceNumber || '________________'}</p>
                        <p><span className="font-semibold text-gray-600">วันที่ออก:</span> {formatDate(data.taxInvoiceDate)}</p>
