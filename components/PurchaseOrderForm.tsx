        ...
        <div className="space-y-8 pt-4">
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <label htmlFor="supplierName" className="block text-xs sm:text-sm font-medium text-slate-700">ชื่อผู้ขาย/บริษัทผู้จำหน่าย</label>
                        <input type="text" id="supplierName" value={data.supplierName} onChange={(e) => handleDataChange('supplierName', e.target.value)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-xs sm:text-sm bg-gray-50" />
                    </div>
                    <div>
                        <label htmlFor="supplierAddress" className="block text-xs sm:text-sm font-medium text-slate-700">ที่อยู่</label>
                        <textarea id="supplierAddress" value={data.supplierAddress} onChange={(e) => handleDataChange('supplierAddress', e.target.value)} rows={3} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-xs sm:text-sm bg-gray-50" />
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
                        <div>
                            <label htmlFor="supplierPhone" className="block text-xs sm:text-sm font-medium text-slate-700">เบอร์โทรศัพท์</label>
                            <input type="text" id="supplierPhone" value={data.supplierPhone || ''} onChange={(e) => handleDataChange('supplierPhone', e.target.value)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-xs sm:text-sm bg-gray-50" />
                        </div>
                        <div>
                            <label htmlFor="supplierEmail" className="block text-xs sm:text-sm font-medium text-slate-700">อีเมล</label>
                            <input type="email" id="supplierEmail" value={data.supplierEmail || ''} onChange={(e) => handleDataChange('supplierEmail', e.target.value)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-xs sm:text-sm bg-gray-50" />
                        </div>
                        <div>
                            <label htmlFor="supplierTaxId" className="block text-xs sm:text-sm font-medium text-slate-700">เลขประจำตัวผู้เสียภาษี</label>
                            <input type="text" id="supplierTaxId" value={data.supplierTaxId || ''} onChange={(e) => handleDataChange('supplierTaxId', e.target.value)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-xs sm:text-sm bg-gray-50" />
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
                    <div>
                        <label htmlFor="purchaseOrderDate" className="block text-xs sm:text-sm font-medium text-slate-700">วันที่ออกใบสั่งซื้อ</label>
                    ...
                    <div>
                        <label htmlFor="expectedDeliveryDate" className="block text-xs sm:text-sm font-medium text-slate-700">วันที่ต้องการรับสินค้า</label>
