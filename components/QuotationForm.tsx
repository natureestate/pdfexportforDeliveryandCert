        ...
        <div className="space-y-8 pt-4">
            ...
            <div className="space-y-6">
                ...
                <div className="text-sm text-gray-600">
                    ...
                    <span className="text-xs text-gray-500 ml-2">(รูปแบบ: QT-YYMMDDXX)</span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label htmlFor="quotationDate" className="block text-sm font-medium text-slate-700">วันที่ออกใบเสนอราคา</label>
                        <input type="date" id="quotationDate" value={formatDateForInput(data.quotationDate)} onChange={(e) => handleDataChange('quotationDate', e.target.value ? new Date(e.target.value) : null)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-gray-50" />
                    </div>
                    <div>
                        <label htmlFor="validUntilDate" className="block text-sm font-medium text-slate-700">วันที่หมดอายุใบเสนอราคา</label>
                        <input type="date" id="validUntilDate" value={formatDateForInput(data.validUntilDate)} onChange={(e) => handleDataChange('validUntilDate', e.target.value ? new Date(e.target.value) : null)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-gray-50" />
                    </div>
                    <div>
